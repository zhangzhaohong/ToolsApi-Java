...
public class Stream_url {
    ...
    private Live_core_sdk_data live_core_sdk_data;
    private Extra extra;
    ...
    public void setLive_core_sdk_data(Live_core_sdk_data live_core_sdk_data) {
         this.live_core_sdk_data = live_core_sdk_data;
     }
     public Live_core_sdk_data getLive_core_sdk_data() {
         return live_core_sdk_data;
     }
